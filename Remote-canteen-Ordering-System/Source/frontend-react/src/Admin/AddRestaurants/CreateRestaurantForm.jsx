          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                error={!!validateForm(formik.values).name}
                helperText={validateForm(formik.values).name}
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                error={!!validateForm(formik.values).description}
                helperText={validateForm(formik.values).description}
              />
            </Grid>
            <Grid item xs={6}>
              <TextField
            ...
            <Grid item xs={12}>
              <TextField
                ...
                error={!!validateForm(formik.values).streetAddress}
                helperText={validateForm(formik.values).streetAddress}
              />
            </Grid>
            <Grid item xs={4}>
              <TextField
