...
public class RestaurantServiceImplementation implements RestaurantService {
	...
	public Restaurant createRestaurant(CreateRestaurantRequest req, Users user) {
		...
		if (req.getAddress() == null || req.getAddress().getCity() == null || req.getAddress().getCity().isEmpty()) {
			throw new IllegalArgumentException("Restaurant address is incomplete");
		}
	...
	@Override
	public RestaurantDto addToFavorites(Long restaurantId, Users user) throws RestaurantException {
		Restaurant restaurant=findRestaurantById(restaurantId);
